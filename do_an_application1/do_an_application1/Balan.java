...
public class Balan {
	...
	protected boolean isIntegerNumber(double num) {
        ...
        //Làm tròn một số double thành một định dạng nhất định và trả về giá trị đã được định dạng dưới dạng chuỗi (String)
